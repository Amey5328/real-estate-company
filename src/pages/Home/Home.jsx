...
import { FaShieldAlt, FaUsers, FaBed, FaBath } from "react-icons/fa";
import { MdLocationOn, MdOutlineSquareFoot } from "react-icons/md";
import { FaBalanceScale } from "react-icons/fa";
import { LuHouse, LuKeyRound, LuBriefcaseBusiness, LuTrendingUp } from "react-icons/lu";
...
function Home() {
  ...
  const reviews = [
    { image: client1, review: "Excellent service and smooth buying experience.", name: "Sarah Johnson" },
    { image: client2, review: "Professional team and transparent process.", name: "Emily Brown" },
    { image: client3, review: "Highly recommend Aurelia for luxury properties.", name: "David Miller" },
  ];
    ...
    <div className="home">
      <section className="hero">
        <Swiper
          ...
          loop={true}
        >
          <SwiperSlide><img src={hero1} className="hero-img" alt="hero 1" /></SwiperSlide>
          <SwiperSlide><img src={hero2} className="hero-img" alt="hero 2" /></SwiperSlide>
          <SwiperSlide><img src={hero3} className="hero-img" alt="hero 3" /></SwiperSlide>
          <SwiperSlide><img src={hero4} className="hero-img" alt="hero 4" /></SwiperSlide>
          <SwiperSlide><img src={hero5} className="hero-img" alt="hero 5" /></SwiperSlide>
        </Swiper>
        ...
        <div className="hero-overlay">
          <div className="home-container">
            ...
            <h5>Book a no-obligation site visit or speak with a senior advisor today.</h5>
            <div>
            ...
            {properties.map((item, index) => (
              <div className="property-card" key={index}>
                ...
                <div className="property-details">
                  ...
                  <span><MdOutlineSquareFoot /> {item.area}</span>
                </div>
          ...
          <div className="feature-box">
            {features.map((item, index) => (
              <div className="box" key={index}>
                ...
                <h3>{item.title}</h3>
                <p>Every transaction is verified with integrity and transparency.</p>
              </div>
            ))}
          </div>
        </div>
